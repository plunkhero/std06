...
#  Model Selection & Drivice Detective
# BERT (Pre-Train) MLM อาศัยการเรียนรู้บริบทของคำรอบๆ ให้ความหมายโดยใช้บริบทคำรอบๆ --> ค่า weight ที่เรียนมาแล้วมาปรับปรุงเพิ่มเติมสำหรับเฉพาะงาน

# 1. Selection model ตามภาษาที่รองรับและขนาดของข้อมูล
MODEL_REGISTRY = {
    "mbert":{
        "hf_name":"bert-base-multilingual-cased",
        "params":"110M",
        "thai_cov":"1%",
        "note":"use in multi language without thai lang(1%)",
    },
    "xlmr":{
        "hf_name":"xml-roberta-base",
        "params":"270M",
        "thai_cov":"5%",
        "note":"RoBERTa architecture, ภาษาไทย ดีกว่า mBERT"
    },
    "wangchanberta":{
        "hf_name":"airesearch/wangchanberta-base-ate-spm-uncased",
        "params":"110M",
        "thai_cov":"100%",
        "note":"ดี่ที่สุดสำหรับ thai legal text"
    }
}

# print(MODEL_REGISTRY.items())

def show_model_comparison():
    print("="*60)
    print("1. เลือก pretrained model าำหรับ thai legal text")
...
# 2 Tokenization (BRT ใช้ subword token แก้ปัญหา out of vecab)
